...
print("\nThis is the Area/Perimeter/Surface Area/Volume of a Shape Calculator")


unit = input("\nWhat unit are you using (mm, cm, m, km, mi, yds, ft, in, etc.) for the measurements?: ")

vora = input("Would you like to calculate an area, perimeter, surface area (of a 3D shape) or volume?: ")


if vora == "area":
    ashape = input("What shape would you like to calculate the area for (rectangle, triangle, circle, parallelogram, trapezoid, rhombus, kite)?: ")
    ...
    vshape = input("What shape would you like to calculate the volume for (sphere, cone, pyramid (various), prism (various))?: ")
    ...
    if vshape == "sphere":
        ...
        covolume = (1/3) * 3.14159265359  * (cor**2) * coh
        print("\nThe volume of the cone is:", covolume, unit, "cubed")
        codp = round(covolume, 2)
        print("or", codp, unit, "cubed (rounded to 2 decimal places).")

    elif vshape == "pyramid":
        pdshape = input("Which pyramid would you like to calculate the volume for (rectangular based or triangular based)?: ")
        ...
        pmshape = input("Which prism would you like to calculate the volume for (circular (cylinder), triangular, rectangular (cuboid))?: ")
    ...
    pshape = input("What (2D) shape would you like to calculate to perimeter for (regular (various), irregular (various) or a circle)?: ")
    ...
    if pshape == "regular":
        ...
        ishape = input("What irregular shape would you like to calculate the perimeter of (rectangle, triangle (non-equilateral) or compound (any other shape))?: ")
        ...
        if ishape == "rectangle":
            ...
            triangle = input("What type of triangle would you like to calculate the perimeter for (isosceles, right-angled or scalene)?: ")
    ...
    if sas == "sphere":
        ...
        psa = input("What type of prism would you like to calculate the surface area for (circular (cylinder), triangular (isosceles or equilateral based), rectangular (cuboid))?: ")
        if psa == "circular":
            ...
            tbb = float(input("What is the breadth (the bottom of the triangle, on the base)?: "))
            tbl = float(input("What is the length?: "))
            tbe = float(input("What is the length of the sides that are equal (in an isosceles triangle)?: "))
            tbh = float(input("What is the height?: "))
            tbsa = tbb * tbh + 2 * tbl * tbe + tbl * tbb
            print("\nThe surface area of the triangular prism is", tbsa, unit, "squared.")
        elif psa == "rectangular":
            rpl = float(input("What is the length of the rectangular prism (cudoid)?: "))
            rpb = float(input("What is the bredth of the rectangular prism (cudoid)?: "))
            rph = float(input("What is the height of the rectangular prism (cudoid)?: "))
            rpsa = 2 * rpl * rpb + 2 * rph * rpb + 2 * rph * rpl
            print("\nThe surface area of the rectangular prism (cudoid) is", rpsa, unit, "squared.")
